...
<head>
    ...
    <style>
        ...
        .card { background: #111; border: 1px solid #333; max-width: 500px; width: 100%; padding: 25px; border-radius: 20px; box-shadow: 0 0 30px rgba(0,100,255,0.05); }
        ...
        .btn-go { width: 100%; padding: 15px; background: #007bff; color: #fff; font-family: 'Anton'; font-size: 1.2rem; border: none; border-radius: 10px; cursor: pointer; }
        .hidden { display: none; }
...
<div class="card">
    ...
    <div id="uiResult" class="hidden text-center mt-4">
        ...
        <a id="dlLink" href="#" class="btn btn-success w-100 mt-3 fw-bold py-3">⬇️ DESCARGAR VIDEO</a>
