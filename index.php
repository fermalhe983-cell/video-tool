<?php
// ==========================================
// VIRAL REELS MAKER v25.0 (GHOST PROTOCOL: MIRROR + ANTI-TRACKING)
// ==========================================
...
if ($action === 'upload' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 1. TRANSFORMACIÓN VISUAL TOTAL
    // hflip: EFECTO ESPEJO (Invierte horizontalmente) -> ¡ESTO CONFUNDE A LA IA!
    // eq=contrast=1.05:saturation=1.1: Cambia la firma de color.
    // noise=alls=2: Ruido digital único.
    
    // Capa de Fondo (Blur) + Espejo
    $filter .= "[0:v]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,boxblur=20:10,hflip[bg];";
    
    // Capa Principal (Video) + Espejo + Color + Ruido
    $filter .= "[0:v]scale=1080:1920:force_original_aspect_ratio=decrease,hflip,eq=contrast=1.05:saturation=1.1,noise=alls=2:allf=t+u[fg];";
...
<head>
    ...
    <title>Ghost Protocol v25</title>
...
<div class="main-card">
    <h1 class="header-title">GHOST v25</h1>
    <p class="text-center text-secondary small">Modo Espejo + Anti-Huella</p>
    ...
    <div id="uiProcess" class="hidden text-center py-5">
        ...
        <h3 class="fw-bold">Aplicando Protocolo...</h3>
        <p class="text-muted small">Invirtiendo geometría y limpiando datos.</p>
    </div>

    <div id="uiResult" class="hidden text-center">
        <h3 class="text-success fw-bold mb-3">¡Video Seguro!</h3>
        <div class="video-box">
